...
const Box2 = () => {
    ...
    return (
        <div className="container mx-auto px-4 py-16 h-1/2 overflow-hidden bg-white-400 pl-20 pr-20">
            ...
            <div className="grid grid-cols-2 gap-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="flex flex-col items-center bg-gray-100 hover:scale-105 transition-transform duration-300 ease-in-out" onClick={() => handlePopup(image5)}>
                        <img
                            src={image5}
                            alt="Product 5"
                            className="w-full h-auto rounded-lg mb-4 cursor-pointer"
                    ...
                    <div className="flex flex-col items-center bg-gray-100 hover:scale-105 transition-transform duration-300 ease-in-out" onClick={() => handlePopup(image6)}>
                        <img
                            src={image6}
                            alt="Product 6"
                            className="w-full h-auto rounded-lg mb-4 cursor-pointer"
                    ...
                    <div className="flex flex-col items-center bg-gray-100 hover:scale-105 transition-transform duration-300 ease-in-out" onClick={() => handlePopup(image7)}>
                        <img
                            src={image7}
                            alt="Product 7"
                            className="w-full h-auto rounded-lg mb-4 cursor-pointer"
                    ...
                    <div className="flex flex-col items-center bg-gray-100 hover:scale-105 transition-transform duration-300 ease-in-out" onClick={() => handlePopup(image8)}>
                        <img
                            src={image8}
                            alt="Product 8"
                            className="w-full h-auto rounded-lg mb-4 cursor-pointer"
