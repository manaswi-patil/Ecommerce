...
//             <div className="w-1/5">
//               {[1, 2, 3, 4].map((i) => (
//                 <img key={i} src={image1} alt={`Thumbnail ${i}`} className="mb-2 cursor-pointer" />
//               ))}
//             </div>
//             <div className="w-4/5">
//               <img src={image1} alt="Asgaard sofa" className="w-full" />
//             </div>
//           </div>
//         </div>
...
//           <p className="text-xl mb-4">Rs. 250,000.00</p>
//           <div className="flex items-center mb-4">
//             <span className="text-yellow-400">★★★★★</span>
//             <span className="ml-2 text-gray-600">5 Customer Review</span>
//           </div>
//           <p className="mb-4">Setting the bar as one of the loudest speakers in its class, the Kilburn is a compact, stout-hearted hero with a well-balanced audio which boasts a clear midrange and extended highs for a sound.</p>
...
//                 <button
//                   key={color}
//                   className={`w-6 h-6 rounded-full ${color === 'yellow' ? 'bg-yellow-500' : `bg-${color}-500`} ${selectedColor === color ? 'ring-2 ring-offset-2 ring-gray-400' : ''}`}
...
//           <div className="flex items-center mb-4">
//             <button onClick={() => setQuantity(Math.max(1, quantity - 1))} className="border px-2 py-1">-</button>
//             <span className="mx-4">{quantity}</span>
//             <button onClick={() => setQuantity(quantity + 1)} className="border px-2 py-1">+</button>
//             <button onClick={handleAddToCart} className="ml-4 bg-black text-white px-4 py-2">Add To Cart</button>
//             <button className="ml-4 border border-black px-4 py-2">Compare</button>
//           </div>
...
import image4 from './../../../src/assets/Asgaard sofa 3.png';
import image5 from './../../../src/assets/Asgaard sofa 3.png';
import Cartpage2 from './../../components/Belowboxes/cartpage3';
